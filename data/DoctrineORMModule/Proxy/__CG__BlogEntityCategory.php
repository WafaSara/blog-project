...
class Category extends \Blog\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Blog\\Entity\\Category' . "\0" . 'id', '' . "\0" . 'Blog\\Entity\\Category' . "\0" . 'label', '' . "\0" . 'Blog\\Entity\\Category' . "\0" . 'createdAt', '' . "\0" . 'Blog\\Entity\\Category' . "\0" . 'updatedAt', '' . "\0" . 'Blog\\Entity\\Category' . "\0" . 'deleted', '' . "\0" . 'Blog\\Entity\\Category' . "\0" . 'posts', '' . "\0" . 'Blog\\Entity\\Category' . "\0" . 'photo', '' . "\0" . 'Blog\\Entity\\Category' . "\0" . 'slug');
        }
