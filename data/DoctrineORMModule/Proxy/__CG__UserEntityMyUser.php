 ...
 */
class MyUser extends \User\Entity\MyUser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MyUser $proxy) {
    ...
    public function setUpdateAt($updatedAt)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUpdateAt', array($updatedAt));

        return parent::setUpdateAt($updatedAt);
    }
